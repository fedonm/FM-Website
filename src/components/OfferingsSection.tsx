...
export const OfferingsSection: React.FC = () => {
  ...
  return (
    <section
      id="offerings"
      className="py-8 md:py-14 relative scroll-mt-20 sm:scroll-mt-24"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mb-8 md:mb-12">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-normal text-stone-900 dark:text-stone-100 tracking-tight leading-tight">
            {language === "el" ? "Τι μπορώ να προσφέρω" : "What I Can Offer"}
          </h2>
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <span
                          className={`font-mono text-xs font-semibold ${isSelected ? "text-teal-700 dark:text-teal-400" : "text-stone-400 dark:text-stone-500"}`}
                        >
                          {category.number}
                        </span>
                        <h3
                      ...
                      {category.badge && (
                        <span
                          className={`text-[10px] uppercase font-mono px-2 py-0.5 rounded-md font-medium shrink-0 ${
                            isSelected
                ...
                >
                  ...
                  <div className="pt-4 border-t border-stone-200/80 dark:border-stone-800 flex items-center justify-between flex-wrap gap-3">
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-sans">
                      {language === "el"
                        ? "Δια ζώσης στη Θεσσαλονίκη & Online παντού"
                        : "In-person in Thessaloniki & Online worldwide"}
                    </span>
                    <button
                      type="button"
                      onClick={() =>
                        handleBookCategory(currentSubcategory.title)
                      }
